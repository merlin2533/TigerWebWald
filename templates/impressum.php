<section class="seiten-header">
    <div class="container">
        ...
        <h1 class="aufdecken">Impressum</h1>
    </div>
</section>
...
<section class="sektion sektion--hell">
    <div class="container">
        <div class="text-seite aufdecken" style="max-width: 800px;">
            ...
            <h2>Kontakt</h2>
            <p>
                Telefon: <a href="tel:<?= e($inhalte['telefon'] ?? '07127/9266-850') ?>"><?= e($inhalte['telefon'] ?? '07127/9266-850') ?></a><br>
                E-Mail: <a href="mailto:<?= e($inhalte['email'] ?? 'info@entenbachtiger.de') ?>"><?= e($inhalte['email'] ?? 'info@entenbachtiger.de') ?></a>
            </p>
            ...
            <h2>Angeschlossen an</h2>
            <p>Tagesmutterverein Reutlingen e.V.</p>
